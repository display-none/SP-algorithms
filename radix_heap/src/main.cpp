...
inline void Main::executeAlgorithm(RadixHeapAlgorithm* algorithm) {
	try {
...
Main::Main(int argc, char** argv) : argc(argc), argv(argv) {
	helper = new ParsingHelper<RadixHeapAlgorithm>("radixHeap");
	algorithmBuilder = new RadixHeapAlgorithmBuilder();
}
